...
const Deposit = () => {
  ...
  return (
    <div className="p-4 md:p-6">
      <h1 className="text-xl md:text-2xl font-bold text-rwanda-dark mb-4 md:mb-6">Deposit Money</h1>
        ...
        <div className="card">
          <div className="flex items-center gap-3 mb-4 md:mb-6">
            <div className="p-2 md:p-3 bg-rwanda-yellow rounded-lg">
              <ArrowDownLeft className="w-5 md:w-6 h-5 md:h-6 text-rwanda-dark" />
            </div>
            <h2 className="text-lg md:text-xl font-semibold">New Deposit</h2>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              >
                ...
                <option value="short-saving">Short Saving</option>
                <option value="long-saving">Long Saving</option>
              </select>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-lg font-bold text-rwanda-blue">
